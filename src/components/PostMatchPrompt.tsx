      ...
      >
        ...
        <div className="mb-2 flex gap-2">
          <label className="flex-1">
            ...
            <select value={map} onChange={(e) => setMap(e.target.value)} className="w-full rounded-xl border border-white/40 bg-white/50 px-3 py-2 text-[13px] text-ink outline-none focus:border-pastelPink/40">
          ...
          <label className="w-24">
            ...
            <select value={result} onChange={(e) => setResult(e.target.value as "W" | "L" | "D")} className="w-full rounded-xl border border-white/40 bg-white/50 px-3 py-2 text-[13px] text-ink outline-none focus:border-pastelPink/40">
        ...
        <div className="mb-2 flex gap-2">
          <label className="flex-1">
            ...
            <input type="number" min="0" value={scoreFor} onChange={(e) => setScoreFor(e.target.value)} placeholder="16" className="w-full rounded-xl border border-white/40 bg-white/50 px-3 py-2 text-[13px] text-ink outline-none placeholder:text-inkDim/40 focus:border-pastelPink/40" />
          </label>
          <label className="flex-1">
            <span className="mb-1 block font-mono text-[10px] tracking-wider text-inkDim">SCORE (THEM)</span>
            <input type="number" min="0" value={scoreAgainst} onChange={(e) => setScoreAgainst(e.target.value)} placeholder="10" className="w-full rounded-xl border border-white/40 bg-white/50 px-3 py-2 text-[13px] text-ink outline-none placeholder:text-inkDim/40 focus:border-pastelPink/40" />
          </label>
        </div>
        ...
        {type !== "personal" && (
          <label className="mb-2 block">
            ...
            <input type="text" value={teamPlayers} onChange={(e) => setTeamPlayers(e.target.value)} placeholder="player1, player2, player3, player4, player5" className="w-full rounded-xl border border-white/40 bg-white/50 px-3 py-2 text-[13px] text-ink outline-none placeholder:text-inkDim/40 focus:border-pastelPink/40" />
          </label>
        )}
        ...
        <div className="mb-2 flex gap-2">
          <label className="flex-1">
            ...
            <input type="number" step="0.01" min="0" value={kd} onChange={(e) => setKd(e.target.value)} placeholder="1.25" className="w-full rounded-xl border border-white/40 bg-white/50 px-3 py-2 text-[13px] text-ink outline-none placeholder:text-inkDim/40 focus:border-pastelPink/40" />
          </label>
          <label className="flex-1">
            <span className="mb-1 block font-mono text-[10px] tracking-wider text-inkDim">ADR</span>
            <input type="number" step="0.1" min="0" value={adr} onChange={(e) => setAdr(e.target.value)} placeholder="82.5" className="w-full rounded-xl border border-white/40 bg-white/50 px-3 py-2 text-[13px] text-ink outline-none placeholder:text-inkDim/40 focus:border-pastelPink/40" />
          </label>
          <label className="flex-1">
            <span className="mb-1 block font-mono text-[10px] tracking-wider text-inkDim">HS%</span>
            <input type="number" step="1" min="0" max="100" value={hsPercent} onChange={(e) => setHsPercent(e.target.value)} placeholder="45" className="w-full rounded-xl border border-white/40 bg-white/50 px-3 py-2 text-[13px] text-ink outline-none placeholder:text-inkDim/40 focus:border-pastelPink/40" />
          </label>
        </div>

        <label className="mb-4 block">
          <span className="mb-1 block font-mono text-[10px] tracking-wider text-inkDim">NOTES</span>
          <textarea value={note} onChange={(e) => setNote(e.target.value)} rows={2} placeholder="Optional..." className="w-full resize-none rounded-xl border border-white/40 bg-white/50 px-3 py-2 text-[13px] text-ink outline-none placeholder:text-inkDim/40 focus:border-pastelPink/40" />
        </label>
